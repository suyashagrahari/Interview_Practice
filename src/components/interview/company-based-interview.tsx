...
interface CompanyBasedInterviewProps {
  onBack?: () => void;
}

const CompanyBasedInterview = ({ onBack }: CompanyBasedInterviewProps) => {
  ...
  const interviewers = [
    {
      ...
      rating: "4.9",
      avatar: "JL",
      specialties: ["Google", "System Design", "Leadership"],
    },
    {
      id: "2",
      name: "Robert Chen",
      ...
      rating: "4.8",
      avatar: "RC",
      specialties: ["Microsoft", "Product Strategy", "Analytics"],
    },
    {
      id: "3",
      name: "Amanda Johnson",
      ...
      rating: "4.7",
      avatar: "AJ",
      specialties: ["Apple", "iOS Development", "Architecture"],
    },
    {
      id: "4",
      ...
      rating: "4.6",
      avatar: "MR",
      specialties: ["Amazon", "AWS", "Scalability"],
    },
    {
      id: "5",
      name: "Sarah Kim",
      ...
      rating: "4.9",
      avatar: "SK",
      specialties: ["Meta", "Frontend", "Team Building"],
    },
  ];
  ...
  const handleStartInterview = () => {
    ...
    window.location.href = `/interview?type=company`;
  };
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-300">
                  Mock Interview Session - Company Specific Questions
                </p>
              </div>
            </div>
                  ...
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        Choose a company to get company-specific interview
                        questions
                      </p>
                    </div>
                  </div>
                          ...
                          <div>
                            ...
                            <p className="text-xs text-blue-700 dark:text-blue-300">
                              {formData.companyName
                                ? `Questions will be tailored for ${
                                    formData.companyName
                                  }${
                                    formData.position
                                      ? ` - ${formData.position}`
                                ...
                                : "Select a company to see what questions will focus on"}
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-gray-200/50 dark:border-white/20 shadow-lg p-4 lg:p-6">
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-300">
                        Select an AI interviewer familiar with the company
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="space-y-2 max-h-80 overflow-y-auto">
                        <div className="p-2 bg-blue-50 dark:bg-blue-500/20 border border-blue-200 dark:border-blue-500/30 rounded-lg">
                          ...
                          <div className="text-xs text-blue-800 dark:text-blue-200">
                            Hello! Welcome to the {formData.companyName}{" "}
                            interview for the {formData.position} position.
