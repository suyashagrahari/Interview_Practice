...
import { Edit, Trash2, Tag, Calendar, Building, Briefcase } from "lucide-react";
import { CompanyQuestionData } from "@/types/upload-questions";

interface CompanyQuestionCardsProps {
  questions: CompanyQuestionData[];
  onEdit: (question: CompanyQuestionData) => void;
  onDelete: (questionId: string) => void;
  isDarkMode: boolean;
}

export const CompanyQuestionCards: React.FC<CompanyQuestionCardsProps> = ({
  questions,
  onEdit,
  onDelete,
  isDarkMode,
            ...
            <motion.div
              ...
              <div className="flex items-start justify-between mb-2">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 text-xs line-clamp-2 leading-relaxed ml-5">
              ...
              <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 pt-1 border-t border-gray-200/50 dark:border-slate-600/50 ml-5">
                <div className="flex items-center gap-1">
