...
interface CompanyPublishModalProps {
  isOpen: boolean;
  questions: CompanyQuestionData[];
  onPublish: (selectedQuestions: CompanyQuestionData[]) => void;
  onCancel: () => void;
  isDarkMode: boolean;
}

export const CompanyPublishModal: React.FC<CompanyPublishModalProps> = ({
  isOpen,
  questions,
  onPublish,
  onCancel,
          ...
          <div
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                Publish Company Questions
              </h2>
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Review and confirm your company questions before publishing
              </p>
            </div>
            <button
              onClick={onCancel}
